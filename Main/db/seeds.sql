...
VALUES
    ...
    ('Marketing Representative', 50000, 5), ('Sr Marketing Representative', 70000, 5), ('Team Lead Marketing', 150000, 5),
    ('Production Analyst', 50000, 6), ('Sr Production Analyst', 60000, 6), ('Production Team Lead', 70000, 6),
    ('Sales Agent', 40000, 7), ('Sr Sales Agent', 50000, 7), ('Team Lead Sales', 40000, 7);
